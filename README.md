...
implementation 'io.github.jkxy:PictureSelector:v3.12.3' //注意和原版名称区别

// image compress library (Not necessary)
implementation 'io.github.jkxy:compress:v3.12.3'

// uCrop library (Not necessary)
implementation 'io.github.jkxy:ucrop:v3.12.3'

// simple camerax library (Not necessary)
implementation 'io.github.jkxy:camerax:v3.12.3'
```
...
当前Fork [JKXY/PictureSelector](https://github.com/JKXY/PictureSelector)：

1. 将照片选择器功能整合到PictureSelector（配置 isUsePhotoPicker 参数）

2. 根据Google推荐和PR兼容部分选择权限实现重选功能（配置 isUseReselection 参数）





Fork [liyuhaolol/PictureSelector](https://github.com/liyuhaolol/PictureSelector):

1. 适配到Android 15 （EdgeToEdge,16k）

2. 实现照片选择器库:PictureChooser



原版 [LuckSiege/PictureSelector](https://github.com/LuckSiege/PictureSelector):

1. 实现选择框架，适配到Android 13（后续未更新）
